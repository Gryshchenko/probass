...
gulp.task('scss', function(){ // Создаем таск scss
	return gulp.src('app/css/**/*.+(scss|sass)') // Берем источник
...
gulp.task('pug', function(){ // Создаем таск "pug"
    ...
    return gulp.src('app/pug/index.pug') // Берем источник
        .pipe(pug({
        pretty: true
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts'], function() {
	gulp.watch('app/css/**/*.scss', ['scss']); // Наблюдение за scss файлами в папке scss
